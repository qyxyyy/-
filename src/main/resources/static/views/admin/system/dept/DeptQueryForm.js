const DeptQueryForm = {
  ...
  <div class="search-area">
    <el-form :inline="true" :model="queryParams" class="demo-form-inline">
        <el-input v-model="queryParams.name" placeholder="部门名" class="search-input"/>
        <el-input v-model="queryParams.manager" placeholder="负责人" class="search-input"/>
        <el-select  v-model="queryParams.status" placeholder="部门状态" class="search-input" clearable>
